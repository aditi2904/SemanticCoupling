...
public class Utility {
    ...
    public static List<Entry<String, Double>> rankDimilarDocuments(Hashtable<String, Double> documentSimilarities) {
        List<Entry<String, Double>> listOfEntries = new ArrayList<Entry<String, Double>>(documentSimilarities.entrySet());

        Collections.sort(listOfEntries, new Comparator<Entry<String, Double>>() {
            @Override
            public int compare(Entry<String, Double> stringDoubleEntry, Entry<String, Double> t1) {
